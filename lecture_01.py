...
def main():
    ...
    print(f"Min id: {result[0]}, Min value: {result[1]}")  # Має вивести: Min id: 10, Min value: 5

    result = findMaxElemWithIndex(listOfData)
    print(f"Max id: {result[0]}, Max value: {result[1]}")  # Має вивести: Max id: 7, Max value: 345
